...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  List<PersistentBottomNavBarItem> bottomNavBarItems = [
    PersistentBottomNavBarItem(icon: Icon(Icons.shield), title: "Wallet", activeColorPrimary: appColor, inactiveColorPrimary: Colors.grey),
    PersistentBottomNavBarItem(icon: Icon(Icons.apps), title: "DApps", activeColorPrimary: appColor, inactiveColorPrimary: Colors.grey),
    PersistentBottomNavBarItem(icon: Icon(Icons.swap_horiz), title: "DEX", activeColorPrimary: appColor, inactiveColorPrimary: Colors.grey),
    PersistentBottomNavBarItem(icon: Icon(Icons.settings), title: "Settings", activeColorPrimary: appColor, inactiveColorPrimary: Colors.grey),
  ];
