...
class _AuthPageState extends State<AuthPage> {
  ...
  onSubmit() async {
    if (isValid) {
      if (useBiometric) {
        bool success = await localAuth.authenticate(localizedReason: "Please authenticate to continue to wallet", biometricOnly: true);
        if (success) Get.offAll(OnboardPage()); else return;
      }
