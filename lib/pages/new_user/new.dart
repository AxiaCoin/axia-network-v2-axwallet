...
class _NewUserPageState extends State<NewUserPage> {
  ...
  TextEditingController passwordController = new TextEditingController(text: kDebugMode ? "test@test.com" : "");
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text("Welcome to your Wallet", style: context.textTheme.caption!.copyWith(fontSize: 24),),
                SizedBox(
                  height: 16,
                ),
                TextFormField(
                ...
                TextFormField(
                  ...
                  validator: (val) => passwordController.text.length < 8 ? "The password should be 8 characters long" : null,
                  onFieldSubmitted: (val) {
                ...
                Container(
                  ...
                  child: ElevatedButton(onPressed: () {
                    onSubmit();
                  }, child: Text(isLoginMode ? "LOGIN" : "REGISTER"), style: MyButtonStyles.onboardStyle,),
                ),
                SizedBox(
                  height: 32,
                ),
                Text.rich(TextSpan(
                    text: isLoginMode ? "Not yet registered? " : "Already registered? ",
                    style: context.textTheme.caption!.copyWith(color: Colors.black),
                    children: [
                      WidgetSpan(
                          child: GestureDetector(
                        behavior: HitTestBehavior.opaque,
                        onTap: () => setState(() => mode = isLoginMode ? Mode.register : Mode.login),
                        child: Text(
