  ...
  Widget build(BuildContext context) {
    AppBar appBar() => AppBar(
          title: TextField(
            ...
            decoration: InputDecoration(hintText: "Search Markets", hintStyle: TextStyle(color: Colors.white), border: InputBorder.none),
          ),
        );
    ...
    Widget trailingWidget(double rand) {
      ...
      String text = isRed ? "-${FormatText.roundOff(rand*10+5, maxDecimals: 2)}%" : "+${FormatText.roundOff(rand*20+7, maxDecimals: 2)}%";
      return Container(
